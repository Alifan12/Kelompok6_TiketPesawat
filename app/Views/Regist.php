          ...
          <div class="tempat_regist">
              ...
              <form action="/RegisterController/save" method="post">
                  <div class="kolom-isian">
                      ...
                      <input type="text" name="Fname" class="input-data" id="InputFname" value="<?= set_value('Fname') ?>">

                  </div>
                  <div class="kolom-isian">
                      <label for="InputBname" class="label-data">Masukkan nama belakang: </label>
                      <input type="text" name="Bname" class="input-data" id="InputBname" value="<?= set_value('Bname') ?>">
                  ...
                  <div class="kolom-isian">
                      ...
                      <input type="password" name="password" class="input-data" id="InputPassword" >
                      
                  </div>
                  <div class="kolom-isian">
                      <label for="Inputconfpassword" class="label-data">Confirmasi password: </label>
                      <input type="password" name="confpassword" class="input-data" id="Inputconfpassword">

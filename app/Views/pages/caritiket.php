  ...
  <div class="container">
    ...
    <form action="/search" method="POST">
      ...
      <div class="penumpang ">
        ...
        <input type="number" name="Dewasa" id="Dewasa" min="0" value=1 disabled>

        <label class="grid-2">Anak-Anak</label>
        <input type="number" name="anak-anakk" id="anak-anakk" min="0" value=0 disabled>

        <label class="grid-3">Bayi</label>
        <input type="number" name="bayi" id="bayi" min="0" value=0 disabled>
      ...
      <div class="kabin">
        ...
        <select name="kelas">
          <option value="" disabled selected>-Silahkan pilih kelas kabin-</option>
